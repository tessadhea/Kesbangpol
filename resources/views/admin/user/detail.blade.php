        ...
        <form method="POST" action="">
            ...
            <div class="field-body">
              <div class="field">
                <div class="control icons-left">
                  <input class="input" id="name" name="name" type="text" placeholder="Name" value="{{ $user->name }}">
          ...
          <label class="label">Username</label>
            <div class="field-body">
              <div class="field">
                <div class="control icons-left">
                  <input class="input" id="name" name="name" type="text" placeholder="Name" value="{{ $user->username }}">
                  <span class="icon left"><i class="mdi mdi-account"></i></span>
                </div>
              </div>
              @error('name')
          ...
          <label class="label">Email</label>
            <div class="field-body">
              <div class="field">
                <div class="control icons-left">
                  <input class="input" id="name" name="name" type="text" placeholder="Name" value="{{ $user->email }}">
                  <span class="icon left"><i class="mdi mdi-account"></i></span>
                </div>
              </div>
              @error('name')
  ...
  <div class="section main-section">
    ...
    <div class="card-content">
            ...
            <div class="field-body">
              <div class="field">
                ...
                <label class="switch mr-2 my-2">
                  ...
                  <form class="button  blue " method="POST" action="{{ route('admin.user.roles.remove',[$user->id, $user_role->id]) }}" onsubmit="return confirm ('apakah anda yakin ingin drop role?');">
                    @csrf
                    @method('DELETE')
      ...
      <div class="card-content">
        ...
        <div class="field">
          <label class="label">Account Permission</label>
          <div class="field-body">
            <div class="field">
              @if ($user->permissions)
              ...
              <label class="switch mr-2 my-2">
                ...
                <form class="button  blue " method="POST" action="{{ route('admin.user.permissions.revoke',[$user->id, $user_permission->id]) }}" onsubmit="return confirm ('apakah anda yakin ingin drop permission?');">
                  @csrf
                  @method('DELETE')

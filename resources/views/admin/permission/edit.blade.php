...
<section class="is-hero-bar">
  <div class="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
    ...
    <a href="{{ route('admin.permission.index') }}" class=" text-3xl hover:text-4xl">  <span class="icon"><i class="mdi mdi-arrow-left-bold-circle  "></i></span></a>
  </div>
            ...
            <div class="field-body">
              <div class="field">
                <div class="control icons-left">
                  <input class="input" id="name" name="name" type="text" placeholder="Name" value="{{ $permission->name }}">
        ...
        <div class="field-body">
          <div class="field">
            ...
            <label class="switch mr-2 my-2">
              ...
              <form class="button  blue " method="POST" action="{{ route('admin.permissions.roles.remove',[$permission->id, $permission_role->id]) }}" onsubmit="return confirm ('apakah anda yakin ingin drop permission?');">
                @csrf
                @method('DELETE')

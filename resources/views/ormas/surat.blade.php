    ...
    <section class="section main-section">
      <div class="card mb-6">
        ...
        <div class="card-content">
          <form method="POST" action="{{ route('ormas.ormas.surat', $ormas->id) }}">
              @csrf
              @method('POST')
              <input type="hidden" name="ormas_id" value="{{ $ormas->id }}">
              <div class="field"> 
            ...
            <div class="field">
                ...
                <div class="field-body">
                  <div class="field">
                    <div class="control icons-left">
                      <input class="input" id="period" name="period" type="text" >
              ...
              <div class="field">
                ...
                <div class="field-body">
                  <div class="field">
                    <div class="control icons-left">
                      <input class="input" id="tanggal2" name="tanggal2" type="text" >
            ...
            <div class="field">
                ...
                <div class="field-body">
                  <div class="field">
                    <div class="control icons-left">
                      <input class="input" id="skt" name="skt" type="text" >

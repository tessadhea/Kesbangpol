    ...
    <section class="section main-section">
      <div class="card mb-6">
        ...
        <div class="card-content">
          <form method="POST" action="{{ route('ormas.ormas.suratrev.update', $surat->id) }}">
              @csrf
              @method('POST')
              ...
              <div class="field-body">
                <div class="field">
                  <div class="control icons-left">
                    <input  value="{{ $surat->tanggal }}" class="input" id="tanggal" name="tanggal" type="text" >
            ...
            <div class="field">
                <label class="label">Periode Kepengurusan</label>
                <div class="field-body">
                  <div class="field">
                    <div class="control icons-left">
                      <input value="{{ $surat->period }}" class="input" id="period" name="period" type="text" >
              ...
              <div class="field">
                <label class="label">Tanggal Paragraf 2</label>
                <div class="field-body">
                  <div class="field">
                    <div class="control icons-left">
                      <input value="{{ $surat->tanggal2 }}" class="input" id="tanggal2" name="tanggal2" type="text" >
            ...
            <div class="field">
                <label class="label">SKT</label>
                <div class="field-body">
                  <div class="field">
                    <div class="control icons-left">
                      <input value="{{ $surat->skt }}" class="input" id="skt" name="skt" type="text" >

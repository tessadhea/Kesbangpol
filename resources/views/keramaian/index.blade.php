...
<section class="is-hero-bar">
  <div class="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
    ...
    @if(auth()->user()->can('tambah_keramaian'))
    <a href="{{ route('keramaian.keramaian.create') }}" class="button blue">Tambah data</a>
    @endif
  </div>
</section>
                                      ...
                                      <div class="card-content">
                                        <div class="flex items-center justify-between">
                                          <div class="widget-label">
                                            <h3>
                                              <a class=" hover:text-red-500 hover:text-xl" href="{{ route('keramaian.keramaian.search1') }}"> Belum di Validasi </a>
                                            </h3>
                                            <h1>
                                          {{ $belum_validasi }}
                                            </h1>
                                    ...
                                    <div class="card w-full">
                                      <div class="card-content">
                                        <div class="flex items-center justify-between">
                                          <div class="widget-label">
                                            <h3>
                                            <a class=" hover:text-green-500 hover:text-xl" href="{{ route('keramaian.keramaian.search2') }}"> Yang Sudah di Validasi </a>
                                            </h3>
                                            <h1>
                                         {{ $validasi }}
                                            </h1>
                                    ...
                                    <div class="card w-full">
                                      <div class="card-content">
                                        <div class="flex items-center justify-between">
                                          <div class="widget-label">
                                            <h3>
                                              <a class=" hover:text-blue-500 hover:text-xl" href="{{ route('keramaian.keramaian.search') }}"> Proses Selesai </a>
                                            </h3>
                                            <h1>
                                              {{ $selesai }}
                                            </h1>
    ...
    <div class="card has-table">
      ...
      <div class="card-content">
        <table>
          ...
          <tbody>
          <tr>
            @foreach($keramaians as $keramaian)
            ...
            <td class="actions-cell">
              <div class="buttons right nowrap">
                <a href="{{ route('keramaian.keramaian.edit', $keramaian->id) }}" class="button  green "  >
                  <span class="icon"><i class="mdi mdi-eye"></i></span>
                </a>
                @if($keramaian->status == 'selesai')
                <a href="{{ route('keramaian.keramaian.finalview', ['filename' => $keramaian->final]) }}" class="button  light "  >
                  <span class="icon">PDF</span>
                </a>
                @endif
               
                @if($keramaian->status == 'ditolak')
                <a href="{{ route('keramaian.keramaian.pesanDitolak', $keramaian->id) }}" class="button  blue "  >
                  <div>
                ...
                <form class="button  red " method="POST" action="{{ route('keramaian.keramaian.destroy', $keramaian->id) }}" onsubmit="return confirm ('apakah anda yakin ingin menghapus data?');">
                  @csrf
                  @method('DELETE')

...
<section class="is-hero-bar">
  <div class="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
    ...
    @if(auth()->user()->can('tambah_ibadah'))
    <a href="{{ route('ibadah.ibadah.create') }}" class="button blue">Tambah data</a>
    @endif
  </div>
</section>
                                      ...
                                      <div class="card-content">
                                        <div class="flex items-center justify-between">
                                          <div class="widget-label">
                                            <h3>
                                            <a href="{{ route('ibadah.ibadah.search1') }}" class="hover:text-red-500 hover:text-xl" > Belum di Validasi </a>
                                            </h3>
                                            <h1>
                                          {{ $belum_validasi }}
                                            </h1>
                                    ...
                                    <div class="card w-full">
                                      <div class="card-content">
                                        <div class="flex items-center justify-between">
                                          <div class="widget-label">
                                            <h3>
                                             <a class="hover:text-green-500 hover:text-xl" href="{{ route('ibadah.ibadah.search2') }}">Yang Sudah di Validasi</a>
                                            </h3>
                                            <h1>
                                         {{ $validasi }}
                                            </h1>
                                    ...
                                    <div class="card w-full">
                                      <div class="card-content">
                                        <div class="flex items-center justify-between">
                                          <div class="widget-label">
                                            <h3>
                                             <a href="{{ route('ibadah.ibadah.search') }}" class="hover:text-blue-500 hover:text-xl"> Proses Selesai </a>
                                            </h3>
                                            <h1>
                                              {{ $selesai }}
                                            </h1>
      ...
      <div class="card-content">
        <table>
          ...
          <tr>
            ...
            <td data-label="Name">{{ $ibadah->nama_RmIbadah }}</td>
            ...
            <td class="actions-cell">
              <div class="buttons right nowrap">
                <a href="{{ route('ibadah.ibadah.edit', $ibadah->id) }}" class="button  green "  >
                  <span class="icon"><i class="mdi mdi-eye"></i></span>
                </a>
                @if($ibadah->status == 'selesai' && $ibadah->final != '')
                <a href="{{ route('ibadah.ibadah.finalview', ['filename' => $ibadah->final]) }}" class="button  light "  >
                  <span class="icon">pdf</span>
                </a>
                @endif
               
                @if($ibadah->status == 'ditolak')
                <a href="{{ route('ibadah.ibadah.pesanDitolak', $ibadah->id) }}" class="button  blue "  >
                  <div>
                ...
                <form class="button  red " method="POST" action="{{ route('ibadah.ibadah.destroy', $ibadah->id) }}" onsubmit="return confirm ('apakah anda yakin ingin menghapus data?');">
                  @csrf
                  @method('DELETE')

    ...
    <section class="section main-section">
      <div class="card mb-6">
        ...
        <div class="card-content">
          <form method="POST" action="{{ route('penelitian.penelitian.suratrev.update', $surat->id) }}">
              @csrf
              ...
              <div class="field">
                ...
                <div class="flex w-full">
                <input type="text" value="{{ $surat->sd}}"  name="sd" placeholder="surat dari"  class="  w-20"> <p class="ml-3  text-xl">/</p>
                <input type="text"  value="{{ $surat->no}}" name="no" placeholder="nomor"  class=" w-20 ml-3"> <p class="ml-3  text-xl">/</p>
                <input type="date" value="{{ $surat->tanggal}}" name="tanggal" placeholder="tanggal"  class=" w-22 ml-3"> <p class="ml-3  text-xl">/</p>
                <input type="text"  value="{{ $surat->hal}}" name="hal" placeholder="perihal" class=" w-32 ml-3"> 
            ...
            <div class="field">
              ...
              <div class="field-body">
                <div class="field">
                    <input  value="{{ $surat->judul}}"  class="input" id="judul" name="judul" type="text" >

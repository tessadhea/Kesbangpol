...
<section class="is-hero-bar">
  <div class="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
    ...
    @if(auth()->user()->can('tambah_penelitian'))
    <a href="{{ route('penelitian.penelitian.create') }}" class="button blue">Tambah data</a>
    @endif
  </div>
</section>
                                      ...
                                      <div class="card-content">
                                        <div class="flex items-center justify-between">
                                          <div class="widget-label">
                                            <h3>
                                             <a href="{{ route('penelitian.penelitian.search1') }}" class="hover:text-red-500 hover:text-xl">Belum di Validasi</a>
                                            </h3>
                                            <h1>
                                          {{ $belum_validasi }}
                                            </h1>
                                    ...
                                    <div class="card w-full">
                                      <div class="card-content">
                                        <div class="flex items-center justify-between">
                                          <div class="widget-label">
                                            <h3>
                                             <a href="{{ route('penelitian.penelitian.search2') }}" class="hover:text-green-500 hover:text-xl">Yang Sudah di Validasi</a>
                                            </h3>
                                            <h1>
                                             {{ $validasi }}
                                            </h1>
                                    ...
                                    <div class="card w-full">
                                      <div class="card-content">
                                        <div class="flex items-center justify-between">
                                          <div class="widget-label">
                                            <h3>
                                              <a class=" hover:text-blue-500 hover:text-xl" href="{{ route('penelitian.penelitian.search') }}">Proses Selesai</a>
                                            </h3>
                                            <h1>
                                              {{ $selesai }}
                                            </h1>
          ...
          <tr>
            ...
            <td class="actions-cell">
              <div class="buttons right nowrap">
                <a href="{{ route('penelitian.penelitian.edit', $penelitian->id) }}" class="button  green "  >
                  <span class="icon"><i class="mdi mdi-eye"></i></span>
                </a>
                @if($penelitian->status === 'selesai')
                <a href="{{ route('penelitian.penelitian.finalview', ['filename' => $penelitian->final]) }}"class="button  light "  >
                  <span class="icon">PDF</span>
                </a>
                @endif
                @if($penelitian->status === 'ditolak')
                <a href="{{ route('penelitian.penelitian.pesanDitolak', $penelitian->id) }}" class="button  blue "  >
                  <div>
                ...
                @endif
                <form class="button  red " method="POST" action="{{ route('penelitian.penelitian.destroy', $penelitian->id) }}" onsubmit="return confirm ('apakah anda yakin ingin menghapus data?');">
                  @csrf
                  @method('DELETE')
